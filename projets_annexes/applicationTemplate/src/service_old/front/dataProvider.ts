/**
 * Universal Data Provider TypeScript - Compatible avec toutes les APIs REST IBM i
 * 
...
export const createUniversalDataProvider = (config: Partial<DataProviderConfig> = {}): UniversalDataProvider => {
  ...
  const parseResponseHeaders = (headers: Headers, resource: string): { total: number } => {
    ...
    if (resourceConfig.parseTotalCount) {
      totalCount = resourceConfig.parseTotalCount(headers, totalCount || null);
    }
  ...
  const dataProvider: UniversalDataProvider = {
     ...
     */
    getMany: async <T extends BaseResource = BaseResource>(
      resource: string, 
      ...
      try {
        ...
        handleError(error as Error, 'getMany', resource);
      }
    },
     ...
     */
    getManyReference: async <T extends BaseResource = BaseResource>(
      resource: string, 
      ...
      try {
        ...
        handleError(error as Error, 'getManyReference', resource);
      }
    },
     ...
     */
    create: async <T extends BaseResource = BaseResource>(
      resource: string, 
      ...
      try {
        ...
        handleError(error as Error, 'create', resource);
      }
    },
     ...
     */
    update: async <T extends BaseResource = BaseResource>(
      resource: string, 
      ...
      try {
        ...
        handleError(error as Error, 'update', resource);
      }
    },
     ...
     */
    updateMany: async <T extends BaseResource = BaseResource>(
      resource: string, 
      ...
      try {
        ...
        handleError(error as Error, 'updateMany', resource);
      }
    },
     ...
     */
    delete: async <T extends BaseResource = BaseResource>(
      resource: string, 
      params: DeleteParams
    ): Promise<GetOneResponse<T>> => {
      try {
        ...
        handleError(error as Error, 'delete', resource);
      }
    },
    ...
    deleteMany: async (resource: string, params: DeleteManyParams): Promise<UpdateManyResponse> => {
      try {
        ...
        handleError(error as Error, 'deleteMany', resource);
      }
    },
     ...
     */
    search: async <T extends BaseResource = BaseResource>(
      resource: string, 
      ...
      try {
        ...
        handleError(error as Error, 'search', resource);
      }
    },
    ...
    getTotal: async (resource: string, filters: SimpleFilters = {}): Promise<number> => {
      try {
        ...
        handleError(error as Error, 'getTotal', resource);
      }
    },
...
export const ResourceConfigs: Record<string, ResourceConfig> = {
  ...
  employees: {
    transformParams: (query: Record<string, any>, params: any) => {
      // Transformations spécifiques aux employés si nécessaire
      return query;
    },
    transformResponse: (data: any, operation: string) => {
  ...
  generic: {
    transformParams: (query: Record<string, any>, params: any) => query,
    transformResponse: (data: any, operation: string) => data
  }
};
